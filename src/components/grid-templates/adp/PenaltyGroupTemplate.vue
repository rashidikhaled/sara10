...
<script>
const groupField = 'CI_Penalty_Group'
const typeField = 'CI_Penalty'
const serviceMethod = 'GetCI_Penalty_FromCI_Penalty_Group'
const componentName = 'PenaltyGroupTemplate'
const responseKey = 'CI_CI_Penalty_FromCI_Penalty_Group'
const paramName = 'pCI_Penalty_Group'
export default {
  name: componentName,
  data () {
    return {
  ...
  watch: {
    dataItem: {
      handler () {
        ...
        this.groupValue = this.dataItem[groupField] || 0
      },
      deep: true
    },
    groupValue () {
