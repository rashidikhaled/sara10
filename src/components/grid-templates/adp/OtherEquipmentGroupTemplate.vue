...
const groupField = "CI_OtherEquipmentGroup"
const typeField = "CI_OtherEquipmentType"
const serviceMethod = "GetCI_OtherEquipmentType_FromCI_OtherEquipmentGroup"
const componentName = "OtherEquipmentGroupTemplate"
const responseKey = "CI_OtherEquipmentType_FromCI_OtherEquipmentGroup"
const paramName = "CI_OtherEquipmentGroup"
...
export default {
  ...
  computed: {
    ...
    selectedDistrict () {
      return this.selectedRequest && this.selectedRequest.BizCode ? convertStringToNosaziCodeObject(this.selectedRequest.BizCode).District : 1
    },
    tdWidth () {
