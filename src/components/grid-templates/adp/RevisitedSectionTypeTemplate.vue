...
<script>
const groupField = "CI_RevisitedSectionType"
const typeField = "CI_RevisitedSectionDataType"
const serviceMethod =
  "GetCI_RevisitedSectionDataType_FromCI_RevisitedSectionType"
const componentName = "RevisitedSectionTypeTemplate"
const responseKey = "CI_RevisitedSectionDataType_FromCI_RevisitedSectionType"
const paramName = "pCI_RevisitedSectionType"
...
export default {
  ...
  methods: {
    ...
    fetchUsingType () {
      ...
      this.$services.equipmentCIengineers
        .getUsingTypeFromUsingGroupEngineers(serviceMethod, {
          [paramName]: this.groupValue
        })
        .then(({ data }) => {
          if (data) {
            let res = data.GetCI_RevisitedSectionDataType_FromCI_RevisitedSectionTypeResult
            this.dependItems = res[responseKey] || []
          }
