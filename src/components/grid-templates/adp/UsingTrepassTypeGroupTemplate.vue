...
<script>
const groupField = "CI_TrepassType_Group"
const typeField = "Id"
const serviceMethod = "GetCI_TrepassType_FromCI_TrepassType_Group"
const componentName = "UsingTrepassTypeGroupTemplate"
const responseKey = "CI_UsingType_FromCI_UsingGroup"
const paramName = "pCI_TrepassType_Group"
...
export default {
  ...
  computed: {
    ...
    ciName () {
      if (!this.column.options) return this.defualtCiName
