...
<script>
const groupField = 'CI_TechnicalStaffRequest'
const typeField = 'CI_TechnicalStaffRequestDetails'
const serviceMethod = 'GetCI_TechnicalStaffRequestAndDetails'
const componentName = 'TechnicalStaffTemplate'
const responseKey = 'GetCI_TechnicalStaffRequestAndDetails'
const paramName = 'pCI_TechnicalStaffRequest'
