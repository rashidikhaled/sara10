...
<script>
const groupField = 'CI_ShahrsaziArchiveGroup'
const typeField = 'CI_ShahrsaziArchiveKind'
const serviceMethod = 'GetCI_ShahrsaziArchiveKind_FromCI_ShahrsaziArchiveGroup'
const componentName = 'ShahrsaziArchiveGroupTemplate'
const responseKey = 'CI_ShahrsaziArchiveKind_FromCI_ShahrsaziArchiveGroup'
