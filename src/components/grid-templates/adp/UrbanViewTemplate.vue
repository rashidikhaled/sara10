...
<script>
const groupField = 'CI_UrbanView'
const typeField = 'CI_UrbanViewDetailes'
const serviceMethod = 'GetCI_UrbanViewDetailes_FromCI_UrbanView'
const componentName = 'UrbanViewTemplate'
const responseKey = 'GetCI_UrbanViewDetailes_FromCI_UrbanView'
const paramName = 'pCI_UrbanView'
