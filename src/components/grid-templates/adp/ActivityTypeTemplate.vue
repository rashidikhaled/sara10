...
<script>
const groupField = "CI_ActivityType"
const typeField = "CI_ActivitySub"
const serviceMethod = "GetCI_ActivitySub_FromCI_ActivityType"
const componentName = "ActivityTypeTemplate"
const responseKey = "CI_ActivitySub_FromCI_ActivityType"
const paramName = "pCI_ActivityType"
...
export default {
  ...
  computed: {
    ...
    ciName () {
      if (!this.column.options) return this.defaultCiName
  ...
  methods: {
    ...
    fetchUsingType () {
      ...
      this.$services.equipmentCIPolice
        .getUsingTypeFromUsingGroupPolice(serviceMethod, {
