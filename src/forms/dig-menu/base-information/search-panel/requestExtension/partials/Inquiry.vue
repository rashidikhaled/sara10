...
export default {
  ...
  data () {
    return {
      requestInquiry: this.value?.ClsRenewal_Request?.Request_Inquiry || Array.isArray(this.value?.ClsRenewal_Request?.Request_Inquiry) ? this.value?.ClsRenewal_Request?.Request_Inquiry : [],
      inquiryColumns: [
        {
