...
export default {
  ...
  data () {
    return {
      model: {
        cIDigDelayTime: this.value?.RevisitRenewal_Request?.Request_Info?.CI_DigDelayTime || "",
        cISplitType: this.value?.RevisitRenewal_Request?.Request_Info?.CI_SplitType || "",
        letterNo: this.value?.RevisitRenewal_Request?.Request_Info?.LetterNo || "",
        letterDate: this.value?.RevisitRenewal_Request?.Request_Info?.LetterDate || "",
        confilictWithOther: this.value?.RevisitRenewal_Request?.Request_Info?.ConfilictWithOther || false,
        requestTimeMojavez: this.value?.RevisitRenewal_Request?.Request_TimeMojavez || [],
        requestTime: this.value?.RevisitRenewal_Request?.Request_Time || [],
        requestOperations: this.value?.RevisitRenewal_Request?.Request_Operations || []
