            ...
            <safa-tabs v-model="activeTab">
              ...
              <tab-content name="Experts" :padding="false">
                <safa-tabs v-model="activeTabExperts">
                  <template v-slot:tabs>
                    <tab-menu name="manageEstate" label="مدیریت املاک" />
                    <tab-menu name="justice" label="دادگستری" />
                  </template>
                  <!-- manageEstate -->
                  <tab-content name="manageEstate">
                    <fit>
                      <!-- <form-row class="q-mb-sm"> // این دو کمبو در سرا 8 عملکردی ندارد ، و عملکرد ان در کد زمل کامنت شده است
                        <FormControl>
                          <safa-combo
                            label="جستجوی نام کارشناس"
                            v-model="comboSearchName1"
                            cdcName="comboSearchName1"
                            label-width="100px"
                            source-type="local"
                            :options="comboOptionsName1"
                            :m="m"
                          />
                        </FormControl>
                        <FormControl>
                          <safa-combo
                            label="جستجوی جزء"
                            v-model="comboSearchJoz1"
                            cdcName="comboSearchJoz1"
                            label-width="100px"
                            source-type="local"
                            :options="model.CI_EvaluationDetails"
                            :m="m"
                          />
                        </FormControl>
                      </form-row> -->
                      <safa-notice>
                        برای جستجو ( نام کارشناس ) و ( جزء ) میتوانید از فیلتر جدول
                        استفاده کنید
                      </safa-notice>
                      <safa-grid
                        v-model="model.Evaluation_Technician_1"
                        cdcName="Evaluation_Technician_1"
                        title=""
                    ...
                    <fit>
                      <!-- <form-row class="q-mb-sm">// این دو کمبو در سرا 8 عملکردی ندارد ، و عملکرد ان در کد زمل کامنت شده است
                        ...
                        <FormControl>
                          <safa-combo
                            label="جستجوی جز"
                            v-model="comboSearchJoz2"
                            cdcName="comboSearchJoz2"
                            label-width="100px"
                            source-type="local"
                            :options="model.CI_EvaluationDetails"
                            :m="m"
