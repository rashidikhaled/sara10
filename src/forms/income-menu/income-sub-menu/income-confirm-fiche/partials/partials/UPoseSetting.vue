  ...
  <section >
      <div class="row q-col-gutter-md q-my-md">
        <div class="col-12 col-sm-6 col-md-4">
         ...
         <UPoseSettingBankShahr class="col-12" v-if="selectedPose===1"/>
         <UPoseSettingBankMeli class="col-12" v-if="selectedPose===2"/>
         <UPoseSettingBankTejarat class="col-12" v-if="selectedPose===3"/>
         <UPoseSettingBankAnsar class="col-12" v-if="selectedPose===4"/>
         <UPoseSettingAsanPardakht class="col-12" v-if="selectedPose===5"/>
         <UPoseSettingBankMelat class="col-12" v-if="selectedPose===6"/>
         <UPoseSettingSamanKish class="col-12" v-if="selectedPose===7"/>
         <UPoseSettingPostBank class="col-12" v-if="selectedPose===9"/>
      </div>
...
import UPoseSettingBankAnsar from './UPoseSettingBankAnsar'
import UPoseSettingAsanPardakht from './UPoseSettingAsanPardakht.vue'
