  ...
  <fit>
    ...
    <safa-tabs :padding="false" fit class="fit" v-model="activeTab">
      ...
      <tab-content v-for="tab in tabsList" :key="tab.key" :name="tab.key">
        <component
          :is="`USearchUTreeInfoUBuilding${tab.key}`"
          :ref="`USearchUTreeInfoUBuilding${tab.key}`"
...
// Components
import USearchUTreeInfoUBuildingApartmentInfo from "./u-search-u-treeInfo-u-building-partials/USearchUTreeInfoUBuildingApartmentInfo"
import USearchUTreeInfoUBuildingInstallation from "./u-search-u-treeInfo-u-building-partials/USearchUTreeInfoUBuildingInstallation"
import USearchUTreeInfoUBuildingUsing from "./u-search-u-treeInfo-u-building-partials/USearchUTreeInfoUBuildingUsing"
...
export default {
  name: "USearchUTreeInfoUBuilding",

  mixins: [baseFormMixin],

  components: {
    USearchUTreeInfoUBuildingApartmentInfo,
    USearchUTreeInfoUBuildingInstallation,
    USearchUTreeInfoUBuildingUsing
  },
