      ...
      <div class="q-pa-sm">
          <form-row :xs="1" :sm="2" :md="2" :lg="2" :xl="4">
            <form-control>
              <safa-text
                v-model="
                  value.Base_Info.LastPayankar_CertificateNo
                "
            ...
            <form-control>
              <safa-text
                v-model="
                  value.Base_Info.LastParvaneh_CertificateNo
                "
            ...
            <form-control>
              <safa-datepicker
                v-model="
                  value.Base_Info.LastPayankar_CertificateDate
                "
            ...
            <form-control>
              <safa-datepicker
                v-model="
                  value.Base_Info.LastParvaneh_CertificateDate
                "
          ...
          <form-row :xs="1" :sm="1" :md="1" :lg="1" :xl="1">
            <form-control>
              <div class="flex items-center q-gutter-x-md">
                ...
                <safa-text
                  style="flex-grow: 1"
                  v-model="value.Base_Info.SubScription_Ab"
                  label="شماره اشتراک آب :"
                  label-width="100px"
                  :m="value.Base_Info.HasAb == 0 ? 'r' : m"
                />
              </div>
            </form-control>
            <form-control>
              <div class="flex items-center q-gutter-x-md">
                ...
                >
                  ...
                  <safa-radio
                    label="دارد"
                    :val="'1'"
                    v-model="value.Base_Info.HasBargh"
                    :m="m"
                  />
                  <safa-radio
                    label="ندارد"
                ...
                <safa-text
                  style="flex-grow: 1"
                  v-model="value.Base_Info.SubScription_Bargh"
                  label="شماره اشتراک برق :"
                  label-width="100px"
                  :m="value.Base_Info.HasBargh == 0 ? 'r' : m"
                />
              </div>
            </form-control>
            <form-control>
              <div class="flex items-center q-gutter-x-md">
                ...
                >
                  ...
                  <safa-radio
                    label="دارد"
                    :val="'1'"
                    v-model="value.Base_Info.HasGaz"
                    :m="m"
                  />
                  <safa-radio
                    label="ندارد"
                ...
                <safa-text
                  style="flex-grow: 1"
                  v-model="value.Base_Info.SubScription_Gaz"
                  label="شماره اشتراک گاز :"
                  label-width="100px"
                  :m="value.Base_Info.HasGaz == 0 ? 'r' : m"
                />
              </div>
            </form-control>
            <form-control>
              <div class="flex items-center q-gutter-x-md">
                ...
                >
                  ...
                  <safa-radio
                    label="دارد"
                    :val="'1'"
                    v-model="value.Base_Info.HasTel"
                    :m="m"
                  />
                  <safa-radio
                    label="ندارد"
                ...
                <safa-text
                  style="flex-grow: 1"
                  v-model="
                    value.Base_Info.SubScription_Telephon
                  "
                  label="شماره اشتراک تلفن :"
                  label-width="100px"
                  :m="value.Base_Info.HasTel == 0 ? 'r' : m"
                />
              </div>
            </form-control>
          </form-row>
        ...
        <internal-section class="q-mb-md" title="فیش">
          <form-row :xs="1" :sm="2" :md="2" :lg="2" :xl="4">
            ...
            <form-control>
              <safa-text
                v-model="value.Base_Info.LastFiche_FromToYear"
                label="از سال تا سال :"
                label-width="100px"
                :m="m"
              />
