   ...
   <fit>
     ...
     <safa-tabs :padding="false" fit class="fit" v-model="activeTab">
       <template v-slot:tabs>
           <tab-menu name="BaseInfo" label="مشخصات" />
           <tab-menu name="OtherInfo" label= "سایر مشخصات" />
           <tab-menu name="UsingFront" label="کاربریها و پیش آمدگیها" />
           <tab-menu name="OtherFacilities" label="سایر امکانات" />
           <tab-menu name="Owner" label="مالکین" />
       ...
       <tab-content name="OtherFacilities">
         <TabOtherFacilities
         v-model="model.dataContext"

         />
       </tab-content>
       <tab-content name="Owner">
         <TabOwner
         v-model="model.dataContext"
...
// Components
import TabBaseInfo from "./partials/TabBaseInfo"
import TabOtherInfo from "./partials/TabOtherInfo"
import TabUsingFront from "./partials/TabUsingFront"
import TabOtherFacilities from "./partials/TabOtherFacilities"
import TabOwner from "./partials/TabOwner"
...
export default {
  ...
  data () {
    return {
      title: "ممیزی- اطلاعات صنف",
      formKey: "ABDC2294-4BB2-4831-AB2C-CB4ED25A7C72",
      main: true,
