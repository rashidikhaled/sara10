<template>
  <fit>
    ...
    <div v-if="!forceReadonly" class="q-mt-sm">
    ...
    <safa-popup
      ...
      vertical
    >
      <form-wrapper :padding="false" title="اطلاعات شغل" hideTitle>
        <job-info
          ref="jobInfo"
          v-model="currentData"
        ...
        try {
          ...
          if (this.result.success) {
            ...
            await this.log({
              ...
              saveDesc: `حذف اطلاعات شغلی پرونده برای شماره درخواست ${this.selectedRequest.NidWorkItem} انجام شد.`
            })
            this.$emit("load")
          } else {
        ...
        try {
          ...
          if (this.result.success) {
            ...
            await this.log({
              ...
              nosaziCode: this.selectedRequest.BizCode,
              nidWorkItem: this.selectedRequest.NidWorkItem,
              saveDesc: `کپی به مجاز پایانکار برای شماره درخواست ${this.selectedRequest.NidWorkItem} انجام شد.`
            })
          } else {
            this.showError("انجام نشد")
          }
      ...
      try {
        ...
        if (this.result.success) {
          ...
          await this.log({
            ...
            nosaziCode: this.selectedRequest.BizCode,
            nidWorkItem: this.selectedRequest.NidWorkItem,
            saveDesc: `نمایش اطلاعات شغلی پرنده برای شماره درخواست ${this.selectedRequest.NidWorkItem} انجام شد.`
          })
          this.jobDialogState = true
        } else {
