    ...
    <form-wrapper :title="title" :padding="false">
      ...
      >
        ...
        <tab-content name="tree_tab">
          <fit>
            ...
            <safa-datatable
              id="eb5f3261-e3b1-4ccc-83aa-94cacfd4a9a8"
              v-model="assignRevisitInfo.Revisits_AllRequest"
              class="q-pa-sm"
              fit
              height="100%"
              helper="citybuilderTheoryCode"
              max-height="100%"
      ...
      <template v-slot:footer>
        <div class="row q-gutter-sm" v-if="placeholder !== 'ArchiveTablet'">
          <!-- <button-group> -->
          <btn-default label="آرشیو" @click="openArchiveTab"></btn-default>
          <btn-default
...
export default {
  ...
  data () {
    return {
      title: 'نظریه شهرساز',
      formKey: '7ea56d64-fe11-4e59-b9cc-377726546bd9',
