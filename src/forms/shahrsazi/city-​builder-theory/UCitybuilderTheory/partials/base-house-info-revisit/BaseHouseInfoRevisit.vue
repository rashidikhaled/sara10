  ...
  >
    ...
    <fit>
      <safa-tabs v-model="activeTab">
        ...
        <tab-menu name="other2" label="سایر"/>
      </template>
      <tab-content name="other2" :padding="true">
      ...
      <!-- <tab-content name="address" title=" آدرس و پلاک ثبتی">
          <tab-address v-model="currentData" v-bind="passedProps" />
        </tab-content> -->
      <!-- <tab-content name="docInfo" title="مشخصات سند">
          <tab-doc-info v-model="currentData" v-bind="passedProps" />
        </tab-content> -->
      <!-- <tab-content
          :padding="false"
          name="baseOwner"
