<template>
  <div class="full-height q-pb-sm">
    <fit>
      ...
      <div v-if="isAyani" class="full-height">
      ...
      <div v-else class="full-height q-px-sm">
      ...
      try {
        ...
        if (this.resultSave.success) {
          ...
          await this.log({
            ...
            saveDesc: `ذخیره اطلاعات صنفی برای شماره درخواست ${this.selectedRequest.NidWorkItem} انجام شد.`
          })
          this.fetch()
        } else {
      ...
      try {
        ...
        if (this.result.success) {
          ...
          await this.log({
            ...
            nosaziCode: this.selectedRequest.BizCode,
            nidWorkItem: this.selectedRequest.NidWorkItem,
            saveDesc: `بارگذاری اطلاعات صنفی برای شماره درخواست ${this.selectedRequest.NidWorkItem} انجام شد.`
          })
        } else {
