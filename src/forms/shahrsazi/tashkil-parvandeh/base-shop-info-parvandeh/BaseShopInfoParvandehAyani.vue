<template>
  <fit>
    ...
    <safa-tabs v-model="currentTab" height="100%" class="fit">
      ...
      <tab-content name="baseUsing" title="کاربری" :padding="false">
      ...
      <tab-content name="comments" title="توضیحات" :padding="false">
      ...
      try {
        ...
        if (this.resultSave.success) {
          ...
          await this.log({
            ...
            nosaziCode,
            saveDesc: `ذخیره اطلاعات پرونده عرصه عیانی برای کدنوسازی ${nosaziCode
              .split("-")
              .reverse()
              .join("-")} انجام گردید`
          })
