<template>
  <safa-form
    id="b5723e30-f485-45ec-9fa4-992386e88eaa"
    caption="شهرسازی- تشکیل پرونده ساختمان"
    app-id="ACE63A06-E835-457D-A1EA-3B477DD9E69B"
  >
    <fit>
      <!-- <safa-securityPanel
        id="92643e73-3540-4bd4-bb65-e4fb94d502c8"
        caption="پیش آمدگی"
        tag="div"
        class="fit"
      > -->
...
export default {
  ...
  watch: {
    'value.Base_Front' () {
      this.value.Base_Front.forEach((x) => {
        if (x.isNew) {
          x.BuildingNo = 1
        }
      })
