          ...
          .then((response) => {
            ...
            this.$services.SA.getBaseLibInNosaziCode(
              ...
              .then((response) => {
                ...
                // console.log('/////@@@@this.fromNosazi', this.fromNosazi)
                //
                // console.log('/////@@@@this.toNosazi', this.toNosazi)

                this.tashkilParvandeCopyPrequest.pFromNidBase = this.fromNosazi.data.HouseObj.NidBase

                this.tashkilParvandeCopyPrequest.pToNidBase = this.toNosazi.data.HouseObj.NidBase

                this.tashkilParvandeCopyPrequest.pNidUser = this.getNidUser()

                this.tashkilParvandeCopyPrequest.pUserName = this.getUserDisplayName()
                ...
                this.$services.SC.tashkilParvandeCopy(
                  ...
                  .then((response) => {
                    ...
                    this.copyResult = this.getResponse(
                      response.data
                    )
