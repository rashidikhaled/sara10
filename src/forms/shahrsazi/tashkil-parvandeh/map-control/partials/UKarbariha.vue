<template>
  <fit>
    <safa-securityPanel
      id="d94c7d78-0529-4a7b-a9cc-d970ff17bd71"
      caption="کاربریهای نقشه - قابل ویرایش"
      tag="div"
      class="fit"
    >
      <!-- <safa-datatable
        v-model="results.Base_Using"
        cdcName="Base_Using"
        :columns="columns"
        ref="karbariha"
        :m="m"
    ...
    async reloadSettings () {
      try {
        ...
        this.Chk_GenerateYear =
          ...
          false
        this.$nextTick().then(() => {
          if (this.$refs.karbariha && this.$refs.karbariha.fetchColumns) this.$refs.karbariha.fetchColumns()
        })
      } catch (e) {
