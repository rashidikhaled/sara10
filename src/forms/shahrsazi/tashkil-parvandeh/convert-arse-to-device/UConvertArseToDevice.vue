...
export default {
  route: 'parvandeh/convert-arse-to-device',
  mixins: [baseFormMixin],
  data () {
    return {
      title: 'شهرسازی- تبدیل عرصه به دستگاه',
      formKey: '87255942-28b8-4bfa-9c88-4123a6326378',
  ...
  methods: {
    ...
    convertArseToDevice (e) {
      this.showConfirm(
        ...
        this.$services.SC.convertHouseToHouseSharing(payLoad, {
          config: {
            District: this.baseNosaziCode.District
          }
        })
