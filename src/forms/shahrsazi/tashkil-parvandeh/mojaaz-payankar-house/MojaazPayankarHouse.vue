    ...
    <fit>
      ...
      >
        <template v-slot:tabs>
          ...
          <tab-menu name="baseOwner" label="مالکین و جهات اربعه" />
          <tab-menu name="houseInfo" label=" مشخصات فنی" />
          <tab-menu name="engineer" label="مهندسین" />
          ...
          <!-- <tab-menu
            ...
            label="کروکی"
          /> -->
          <tab-menu name="plans" label="طرح تفصیلی و توضیحات" />
        </template>
        ...
        <tab-content name="engineer" title="مهندسین">
          <TabEngineer v-model="currentData" v-bind="passedProps" :name="name" />
        </tab-content>
