    ...
    >
      <fit>
       ...
       />-->
        ...
        <div
          :class="['fit flex items-center justify-center', $q.dark.isActive?'bg-dark text-light' : 'bg-grey-2 text-grey']"
          v-else
        >
          <q-icon
            color="blue"
...
export default {
  ...
  computed: {
    ...
    readonlyMode () {
      return true // this.formName !== 'UIncome' && this.formName !== 'UElameZabete'
    },
    getBtn () {
      if (this.formName === 'UIncome') {
...
<style lang="scss">
#responder-forms button.ribbon-button.form-button {
  min-width: 78px;
