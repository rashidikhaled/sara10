...
import { ClsEnumEumObjOnPrice } from 'src/forms/garbage/config/enums.js'
...
export default {
  ...
  data: function () {
    return {
      ...
      getClsEnumEumObjOnPrice: ClsEnumEumObjOnPrice
    }
  },
  props: {
    ...
    save () {
      this.showConfirm(
        ...
        const payload = {
          ...
          pEumObjOnPrice: this.getClsEnumEumObjOnPrice.Pasmand,
