  ...
  <fit>
    <safa-tabs v-model="activeTab">
      <template v-slot:tabs>
        <tab-menu name="tavafoghUses" label="کاربری های توافق شده" />
        <tab-menu name="determiningTavafogh" label="تعیین توافق" />
        <tab-menu name="parameters" label="پارامتر ها" />
        <tab-menu name="description" label="توضیحات" />
      </template>

      <tab-content name="tavafoghUses" :padding="false">
        <fit>
      ...
      <tab-content name="determiningTavafogh" :padding="false">
        <fit>
          <safa-datatable
            :columns="serviceAssignmentAgreements"
            v-model="model.Base_PlanForWork"
            cdcName="Base_PlanForWork"
            title="توافقات واگذاری خدمات"
            fit
            height="100%"
            min-height="200px"
            max-height="100%"
      ...
      <tab-content name="parameters" :padding="false">
        <fit>
          <safa-datatable
            ...
            v-model="model.AgreementParameters"
            cdcName="AgreementParameters"
            title="پارامتر ها"
            fit
            height="100%"
            min-height="200px"
        ...
        <FormRow>
          <FormControl>
            <safa-combo
              ...
              label-width="90px"
              m="r"
              v-model="model.Sh_Agreement.CI_UsingConfirmRefrence"
              cdcName="CI_UsingConfirmRefrence"
            />
          </FormControl>
          <text-template
            label="توضیحات توافقنامه"
            label-width="90px"
            m="r"
            v-model="model.Sh_Agreement.Comments"
            cdcName="Comments"
          />
        </FormRow>
      </tab-content>
  ...
  data () {
    return {
      ...
      serviceAssignmentAgreements: [
        ...
        { field: "Confirms", title: "تأیید کنندگان", width: "120px" },
        { field: "Comments", title: "ملاحظات", width: "auto" }
      ],
      parametersColumns: [
        {
          field: "Caption",
