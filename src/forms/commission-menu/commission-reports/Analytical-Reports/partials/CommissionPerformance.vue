  ...
  <fit>
    ...
    >
      <template v-slot:before>
        <fit>
          <safa-datatable
            title="لیست عملکرد کمیسیون"
            v-model="result.CommissiomnAnalyze"
            cdcName="commissionAnalyze"
            helper="commissionAnalyzeColumns"
...
export default {
  ...
  data () {
    return {
      name: 'PerformanceOfAreas',
      title: 'عملکرد کمیسیون',
