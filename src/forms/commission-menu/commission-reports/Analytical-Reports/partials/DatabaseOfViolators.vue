  ...
  <fit>
    ...
    >
      <template v-slot:before>
        <fit>
          <safa-datatable
            title="لیست اطلاعات متخلفین"
            v-model="result.ViolatorsAnalyze"
            cdcName="violatorsAnalyze"
            helper="violatorAnalyzeColumns"
...
export default {
  ...
  data () {
    return {
      name: 'DatabaseOfViolators',
      title: 'بانک اطلاعات متخلفین',
