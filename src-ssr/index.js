...
// ###################
// NOTE: res.locals.nonce has to be added to the context variable inside the
//       renderToString function line 47-52 in in node_modules/@quasar/app/lib/webpack/ssr/template.ssr.js
//       (or on every ssr build, res.locals.nonce can be added to the already generated
//       template in dist/ssr/ssr.js)
//
// EXAMPLE:
// const ctx = {
...
// Add only self (will cause error)
// app.use(csp({
//   directives: {
//     scriptSrc: [
//       "'self'"
